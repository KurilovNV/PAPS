...
В этом примере у нас есть интерфейс ILearningStrategy, представляющий метод Learn, который реализуют конкретные стратегии обучения, такие как VocabularyLearningStrategy и SpeakingLearningStrategy.
